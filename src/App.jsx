...
export default function App() {
    ...
    const playerAction = (type, payload) => {
        ...
        if (type === "attack") {
            ...
            else if (ab.type === "deathSuffering") { if (cse.enemyDot > 0) { addLog("💀 Death's Suffering already active!", "#a0ffa0"); np.mp = clamp(np.mp + ab.cost - regen, 0, np.maxMp); actionLockRef.current = false; setPlayer(np); return; } cse.enemyDot = 4; triggerAnim("enemy", "dark", "💀DoT", "#a0ffa0"); addLog("💀 Your Death's Suffering — 8% HP/turn x4!", "#a0ffa0"); }
